...
const CONTRACTS = [
  ...
  { id: 'erp-global-bridge', source: 'components/Shell.jsx', signals: ['<CollaborationBridge />', '<WorkspaceSurfaceSwitch />'] },
  ...
  { id: 'remembered-surface-login', source: 'app/login/page.jsx', signals: ['preferredWorkspaceSurface', "=== 'realm' ? '/realm' : '/dashboard'"] },
