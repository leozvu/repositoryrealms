...
const CONTRACTS = [
  ...
  { id: 'schema-readiness-current', layer: 'health', source: 'lib/realm-health.js', signals: ['REALM_SCHEMA_VERSION = 6', '20260718230000_extend_realm_action_receipts', "missing.push('action_receipts')"] },
];
