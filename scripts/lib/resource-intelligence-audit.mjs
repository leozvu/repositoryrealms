...
const CONTRACTS = [
  ...
  { id: 'my-work-intelligence', layer: 'ui', source: 'app/(app)/myday/page.jsx', signals: ['Estimate là khai báo phạm vi', 'TimeLog là dữ liệu tự khai báo', 'Cập nhật estimate'] },
  { id: 'team-work-intelligence', layer: 'ui', source: 'app/(app)/teamwork/page.jsx', signals: ['TimeLog tự khai báo', 'business rule, receipt và audit', 'Lưu hiệu chỉnh có receipt'] },
