...
const CONTRACTS = [
  ...
  { id: 'personal-cockpit', layer: 'ui', source: 'app/(app)/myday/page.jsx', signals: ['PageHeader', '/api/execution/my-work', 'task.reprioritize'] },
  { id: 'manager-orchestrator', layer: 'ui', source: 'app/(app)/teamwork/page.jsx', signals: ['title="Ngoại lệ và phân bổ công việc"', '/api/execution/team-work', 'ReceiptBar'] },
