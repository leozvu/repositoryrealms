...
const CONTRACTS = [
  ...
  { id: 'accessible-responsive-ui', layer: 'style', source: 'components/realm/realm-pilot-operations.module.css', signals: ['button { min-height: 44px;', '@media (max-width: 680px)', '.metrics, .waveFacts, .criteria { grid-template-columns: 1fr;', '@media (prefers-reduced-motion: reduce)'] },
