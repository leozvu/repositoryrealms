...
const CONTRACTS = [
  ...
  { id: 'both-surfaces-persist-choice', layer: 'client', source: 'components/realm/RealmOffice.jsx', signals: ["persistWorkspaceSurface('erp')", 'Mở workspace ERP CRM gốc', 'ERP · CRM'] },
