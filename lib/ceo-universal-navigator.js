...
const PORTAL_WORKSPACES = Object.freeze([
  ...
  { id: 'overview', href: '/ceo-overview', icon: 'dashboard', vi: ['Tổng quan tập đoàn', 'Snapshot vận hành của AIm, Egoric (gồm phòng Egolive) và Vnecom.'], en: ['Group overview', 'Operating snapshots for AIm, Egoric (including its Egolive department), and Vnecom.'], keywords: ['dashboard', 'portfolio', 'snapshot', 'tổng quan'] },
  ...
  { id: 'world', href: '/ceo-world', icon: 'shield', vi: ['Bản đồ ba vương quốc', 'Vào Realm của từng công ty qua gateway đã xác thực.'], en: ['Three-kingdom map', 'Enter each company Realm through an authenticated gateway.'], keywords: ['realm', 'map', 'kingdom', 'bản đồ'] },
...
const ENTITY_WORKFLOWS = Object.freeze([
  ...
  { id: 'calendar', redirectPath: '/calendar', icon: 'calendar', capability: 'people', vi: ['Lịch cộng tác', 'Mở lịch làm việc và availability tại công ty sở hữu.'], en: ['Collaboration calendar', 'Open the owning company work calendar and availability.'], keywords: ['calendar', 'meeting', 'availability', 'lịch', 'cuộc họp'] },
  ...
  { id: 'livestream', redirectPath: '/live', icon: 'calendar', capability: 'livestream', vi: ['Lịch live Egolive', 'Mở lịch live của phòng Egolive thuộc Egoric.'], en: ['Egolive schedule', 'Open live operations for Egoric’s Egolive department.'], keywords: ['egolive', 'live', 'host', 'ca live'] },
]);
