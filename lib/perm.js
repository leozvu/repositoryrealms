...
// Vai trò nhân viên nội bộ (dùng cho ô chọn vai trò). FREELANCER là vai trò riêng,
// gán tự động cho tài khoản freelancer — KHÔNG nằm trong danh sách nội bộ.
...
export const ROLE_LABEL = {
  ...
  HR: 'HR', LEAD: 'Trưởng nhóm', STAFF: 'Nhân viên', MANAGER: 'Quản lý (cũ)', FREELANCER: 'Freelancer',
};
...
// v3.11: freelancer = người ngoài, không có quyền nhân viên nào
export const isFreelancer = u => u?.userType === 'freelancer' || rolesOf(u).includes('FREELANCER');
