...
export function persistWorkspaceSurface(surface) {
  const normalized = rememberWorkspaceSurface(surface);
  if (typeof window !== 'undefined') {
    window.fetch('/api/realm-demo/pilot', {
      method: 'PUT',
