...
const DOMAIN_MAP = Object.freeze({
  tasks: ['operations', 'guild', 'campaigns', 'command', 'rewards', 'chronicle'],
  timelogs: ['operations', 'command', 'chronicle'],
  approvals: ['command', 'notifications', 'chronicle'],
  leaves: ['chronicle'],
  attendance: ['chronicle'],
  taskcomments: ['operations', 'campaigns'],
  activities: ['embassy'],
  taskevents: ['operations', 'campaigns'],
  projects: ['guild', 'campaigns', 'chronicle'],
  phases: ['campaigns'],
  milestones: ['campaigns'],
  users: ['directory', 'guild', 'command', 'chronicle'],
  teams: ['directory', 'guild', 'campaigns'],
  leads: ['embassy'],
  clients: ['embassy'],
  contacts: ['embassy'],
  settings: ['access', 'operations', 'guild', 'campaigns', 'command', 'embassy', 'rewards'],
  realm_profile: ['operations', 'directory', 'chronicle'],
  realm_gold: ['operations', 'treasury', 'rewards', 'chronicle'],
