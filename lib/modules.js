...
export const MODULE_GROUPS = [
  ...
  { mod: 'inventory', label: 'Kho hàng / Lô', desc: 'Nhập–xuất–tồn theo lô, giá vốn đích danh, truy xuất nguồn gốc (lô ↔ vùng trồng), cảnh báo hạn dùng' },
...
export const MODULE_PRESETS = {
  ...
  egoric: { label: 'Egoric Agency + Phòng Livestream Egolive', mods: ['sales', 'services', 'support', 'tasks', 'delivery', 'commissions', 'procurement', 'freelancers', 'recruitment', 'reviews', 'analytics', 'livestream'] },
  export: { label: 'Xuất nhập khẩu nông sản', mods: ['sales', 'tasks', 'procurement', 'recruitment', 'export', 'inventory'] },
...
export const DEFAULT_OFF = ['export', 'livestream', 'inventory'];
...
export const RESOURCE_MOD = {
  ...
  stocklots: 'inventory', stockmoves: 'inventory',
