...
export const MODULE_GROUPS = [
  { mod: 'sales', label: 'Bán hàng / CRM', desc: 'Khách tiềm năng, báo giá, bảng giá dịch vụ' },
  { mod: 'support', label: 'Chăm sóc khách hàng', desc: 'Ticket hỗ trợ + SLA' },
  { mod: 'delivery', label: 'Vận hành dự án', desc: 'Dự án, công việc, Gantt, chấm công giờ, mẫu dự án, nguồn lực — cho mô hình bán theo dự án' },
  ...
  // Phân hệ đặc thù sẽ thêm ở các phiên sau (chưa có trang, để sẵn khung):
  { mod: 'export', label: 'Xuất nhập khẩu', desc: 'Vùng trồng, chứng từ XNK, lô hàng, đa tiền tệ — cho DN xuất khẩu', soon: true },
  { mod: 'livestream', label: 'Livestream bán hàng', desc: 'Ca live, đối soát sàn TikTok/Shopee, công host', soon: true },
];

// Preset — bật nhanh theo loại hình công ty.
export const MODULE_PRESETS = {
  agency: { label: 'Agency Marketing', mods: ['sales', 'support', 'delivery', 'commissions', 'procurement', 'freelancers', 'recruitment', 'reviews', 'analytics'] },
  export: { label: 'Xuất nhập khẩu nông sản', mods: ['sales', 'procurement', 'recruitment', 'export'] },
  livestream: { label: 'Livestream bán hàng', mods: ['commissions', 'freelancers', 'reviews', 'livestream'] },
};

// Có bật phân hệ `mod` không? modules = Setting.modules (mảng | undefined).
// mod rỗng/null = lõi → luôn bật. undefined modules (công ty cũ) = bật hết.
