...
export const RESOURCE_MOD = {
  leads: 'sales', quotes: 'sales', services: 'sales',
  tickets: 'support',
  projects: 'delivery', tasks: 'delivery', milestones: 'delivery', phases: 'delivery',
  taskcomments: 'delivery', taskevents: 'delivery', timelogs: 'delivery',
