...
export function deploymentBranding(env = process.env) {
  if (isCeoPortalDeployment(env)) {
    return {
      ...
      logoLetter: 'L',
      subtitle: 'Điều hành hợp nhất · 3 công ty',
      description: 'Trung tâm điều hành hợp nhất cho AIm Agency, Egoric Agency (gồm phòng Egolive) và Vnecom LLC.',
