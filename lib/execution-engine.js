...
export function compareWorkItems(left, right) {
  ...
  // Feedback AIm đợt 3 (07/2026): bỏ "độ ưu tiên" khỏi thuật toán sắp — thứ tự là của
  // NGƯỜI DÙNG (queuePosition); việc chưa sắp tay thì theo deadline, thứ duy nhất họ quan tâm.
