...
const CONTRACTS = [
  ...
  {
    action: 'lead.expected_close.update',
    intent: 'set_expected_close_with_cas',
    resource: 'leads',
    surface: 'embassy',
    authorization: ['registry.canWrite(leads)', 'embassy portfolio scope'],
    businessRules: ['expected-value CAS', 'valid calendar day or explicit clear'],
    receipt: 'RealmActionReceipt with payload hash',
    audit: 'Payload-free AuditLog in the record transaction',
  },
  {
    action: 'lead.source.update',
    intent: 'set_lead_source_with_cas',
    resource: 'leads',
    surface: 'embassy',
    authorization: ['registry.canWrite(leads)', 'embassy portfolio scope'],
    businessRules: ['expected-value CAS', 'bounded source taxonomy value'],
    receipt: 'RealmActionReceipt with payload hash',
    audit: 'Payload-free AuditLog in the record transaction',
  },
  {
