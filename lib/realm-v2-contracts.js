export const REALM_V2_AREAS = Object.freeze([
  { slug: 'home', label: 'Great Hall', labelVi: 'Đại sảnh Realm', group: 'Work', icon: 'home', template: 'focus', canonicalPath: '/dashboard' },
  ...
  { slug: 'collaboration', label: 'Guild Commons', labelVi: 'Đại sảnh cộng tác', group: 'Operations', icon: 'people', template: 'focus', canonicalPath: '/teamwork' },
  { slug: 'world-map', label: 'Kingdom Map', labelVi: 'Bản đồ bốn vương quốc', group: 'Intelligence', icon: 'map', template: 'map', canonicalPath: '/ceo-world' },
  ...
  { slug: 'recognition', label: 'Gold Treasury', labelVi: 'Kho bạc Gold', group: 'People', icon: 'ledger', template: 'registry', canonicalPath: '/realm' },
