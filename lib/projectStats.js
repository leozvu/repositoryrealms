...
// Chi phí lao động = Σ(giờ log × đơn giá giờ theo lương người đó)
export function laborCost(timeLogs, usersById) {
  return Math.round(timeLogs.reduce((s, l) => s + l.hours * hourRate(usersById[l.userId]?.salary || 0), 0));
}
