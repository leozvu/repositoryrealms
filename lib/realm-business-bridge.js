...
const MEDIEVAL_META = {
  ...
  docs: ['Royal Archive', 'Kho lưu trữ', 'Tổng quan'], // v3.37: Tài liệu công ty
  ...
  'ceo-navigator': ['Royal Wayfinder', 'Cổng điều hành CEO', 'Công ty'],
  'ceo-briefing': ['Royal Morning Briefing', 'Phòng điều hành CEO', 'Công ty'],
  'ceo-decisions': ['Royal Decision Docket', 'Phòng nghị sự CEO', 'Công ty'],
  'ceo-world': ['Realm Federation Atlas', 'Bản đồ ba vương quốc', 'Công ty'],
  'ceo-commands': ['Royal Dispatch', 'Phòng điều hành CEO', 'Công ty'],
  'ceo-workforce': ['Guild Workforce Exchange', 'Phòng điều hành CEO', 'Công ty'],
