...
export const CEO_SERVICE_SCOPES = Object.freeze({
  ...
  LEOZOPS_TASK_PREVIEW: 'leozops.task.create.preview',
  LEOZOPS_TASK_APPROVE: 'leozops.task.create.approve',
  LEOZOPS_TASK_EXECUTE: 'leozops.task.create.execute',
  LEOZOPS_TASK_ROLLBACK_PREVIEW: 'leozops.task.create.rollback.preview',
  LEOZOPS_TASK_ROLLBACK_APPROVE: 'leozops.task.create.rollback.approve',
  LEOZOPS_TASK_ROLLBACK_EXECUTE: 'leozops.task.create.rollback.execute',
  LEOZOPS_TASK_RECEIPTS_READ: 'leozops.task.create.receipts.read',
...
export const CEO_SERVICE_RATE_LIMITS = Object.freeze({
  ...
  [CEO_SERVICE_SCOPES.LEOZOPS_TASK_PREVIEW]: 30,
  [CEO_SERVICE_SCOPES.LEOZOPS_TASK_APPROVE]: 20,
  [CEO_SERVICE_SCOPES.LEOZOPS_TASK_EXECUTE]: 10,
  [CEO_SERVICE_SCOPES.LEOZOPS_TASK_ROLLBACK_PREVIEW]: 20,
  [CEO_SERVICE_SCOPES.LEOZOPS_TASK_ROLLBACK_APPROVE]: 10,
  [CEO_SERVICE_SCOPES.LEOZOPS_TASK_ROLLBACK_EXECUTE]: 10,
