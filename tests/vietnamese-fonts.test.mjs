...
test('global body, mono and heritage fonts bundle Vietnamese glyphs without runtime Google CSS', () => {
  ...
  assert.match(layout, /variable: '--font-realm-display'/);
...
test('ERP and Realm typography tokens use the bundled Vietnamese font families', () => {
  ...
  assert.match(css, /--font-display:var\(--font-realm-display\)/);
